...
class FNTTNiagaraBoundsCalculatorHelper : public FNiagaraBoundsCalculator
{
public:

	FNTTNiagaraBoundsCalculatorHelper() = default;
	FNTTNiagaraBoundsCalculatorHelper(const FVector& InMeshExtents, const FVector& InMaxLocalMeshOffset, const FVector& InMaxWorldMeshOffset, bool bInLocalSpace)
